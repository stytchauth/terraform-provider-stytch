	...
	resp.Schema = schema.Schema{
		Attributes: map[string]schema.Attribute{
			...
			"vertical": schema.StringAttribute{
				Required:    true,
				Description: "The project's vertical.",
			},
...
func (r *projectResource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	...
	// TODO: Generate API request body from plan and call r.client.Projects.Create
...
func (r *projectResource) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
	...
	// TODO: Generate API request body from plan and call r.client.Projects.Update
...
func (r *projectResource) Delete(ctx context.Context, req resource.DeleteRequest, resp *resource.DeleteResponse) {
	...
	// TODO: Call r.client.Projects.Delete
}
